     ...
     <form className="flex flex-col mb-24 space-y-4 p-6 shadow-lg">
        <label className="flex flex-col text-lg font-medium text-black">
            ...
            <input type={"email"} placeholder="Please Enter Email"
             className='outline-none px-2 py-1 w-[20rem] text-[1rem] 
             font-normal bg-transparent border border-gray-400' />
        </label>
        <label className="flex flex-col text-lg font-medium text-black">
            Mobile
            <input type={"email"} placeholder="Please Enter Mobile"
             className='outline-none px-2 py-1 w-[20rem] text-[1rem] 
             font-normal bg-transparent border border-gray-400' />
        </label>
        <label className="flex flex-col text-lg font-medium text-black">
            Message
            <textarea type={"email"} placeholder="Please Enter Message"
             className='outline-none px-2 py-1 w-[20rem] text-[1rem] 
             font-normal bg-transparent border border-gray-400' />
        </label>
